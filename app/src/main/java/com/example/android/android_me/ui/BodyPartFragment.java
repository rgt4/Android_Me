...
public class BodyPartFragment extends Fragment {
    ...
    final static String ID_IMAGE_IDS = "id_image_ids";
    final static String ID_SELECTED_IMAGE_ID = "id_selected_image_id";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds= savedInstanceState.getIntegerArrayList(ID_IMAGE_IDS);
            mListIndex = savedInstanceState.getInt(ID_SELECTED_IMAGE_ID);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(ID_IMAGE_IDS,(ArrayList<Integer>) mImageIds);
        outState.putInt(ID_SELECTED_IMAGE_ID,mListIndex);
    }
}
